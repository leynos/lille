...
//! and events are available to the engine without requiring the full Bevy
//! renderer. It intentionally avoids spawning geometry or entities so the DBSP
//! circuit remains the source of truth for inferred behaviour; later tasks in
//! the roadmap will layer map loading and component translation on top of this
//! entry point.
